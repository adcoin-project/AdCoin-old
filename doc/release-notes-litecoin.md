...
To receive security and update notifications, please subscribe to:
  ...
  <https://groups.google.com/forum/#!forum/adcoin-dev>
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/adcoin-project/adcoin/blob/master/doc/zmq.md) for
...
Commands sent over the JSON-RPC interface and through the `adcoin-cli` binary
can now use named arguments. This follows the [JSON-RPC specification](http://www.jsonrpc.org/specification)
for passing parameters by-name with an object.

`adcoin-cli` has been updated to support this by parsing `name=value` arguments
when the `-named` option is given.

Some examples:

    src/adcoin-cli -named help command="help"
    src/adcoin-cli -named getblockhash height=0
    src/adcoin-cli -named getblock blockhash=000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f
    src/adcoin-cli -named sendtoaddress address="(snip)" amount="1.0" subtractfeefromamount=true
...
here, originally written for Bitcoin but can also be used for AdCoin:
