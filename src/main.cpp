...
uint256 hashGenesisBlock("0x6da2f2ef5b0f62c0717dbbd687826b0e9e6fe08cf0c61c8f40173efadd49a9f9");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1499175910, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0463e69cece8518844a0abc1403afc046e6e69cfd43d250b1ebf08f138ef4502b18e17e7a6097ad40ddf3e043e0b63f91ad703c993e41aa692430eac9e3e00d334") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1499175910;
        ...
        assert(block.hashMerkleRoot == uint256("0x93c2ed969aedded98026e9ee8f2c0c6213329d1f4e3b0df19a53d01378e40cd4"));
...
unsigned char pchMessageStart[4] = { 0x3d, 0x05, 0x35, 0x77 }; // AdCoin: increase each by adding 2 to bitcoin's value.
